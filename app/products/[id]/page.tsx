...
export async function generateMetadata({ params }: { params: { id: string } }) {
  ...
  return {
    ...
    description: `${product.product_name} by ${product.product_seller} - $${product.price} - ${product.condition || 'Used'}`,
  };
}
      ...
      <div className="product-details-wrapper">
              ...
              <div className="product-info-table">
                ...
                <div className="info-list">
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">{product.condition || 'Used - Good'}</span>
                  </div>
                  <div className="info-row">
        ...
        <div className="description-section">
          ...
          <div className="description-content">
            ...
            <p className="description-text">
              All items are sold as-is. Please contact the seller for any specific questions about condition, 
              measurements, or additional details before making your purchase decision.
            </p>
          </div>
        </div>
      </div>
